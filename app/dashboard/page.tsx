...
export default function DashboardLayout() {
  ...
  if (loading) return <div className="flex h-screen items-center justify-center bg-[#0a0a0a] text-orange-500 font-black italic tracking-tighter text-3xl">LOADING ARENA...</div>;

  return (
    <div className="min-h-screen bg-[#0a0a0a] text-gray-400 p-6 pt-28">
      {/* GRID CONFIGURATION:
          Mobile: 1 column
          Desktop (xl): 3 columns [2 parts wide | 3 parts wide | 2 parts wide]
      */}
      <div className="grid grid-cols-1 xl:grid-cols-[2fr_3fr_2fr] gap-8 max-w-[1600px] mx-auto">
        
        {/* === LEFT COLUMN: SQUAD & TOURNAMENTS === */}
        <div className="space-y-6">
          {/* Squad Status Card */}
          <DashboardCard title="Your Squad">
            <div className="text-center py-4">
              ...
              <div className="flex gap-2 mt-6">
                <button className="flex-1 bg-white text-black text-xs font-black py-3 rounded hover:bg-gray-200 transition-colors uppercase">Join</button>
                <button className="flex-1 border border-[#333] text-white text-xs font-black py-3 rounded hover:bg-[#222] transition-colors uppercase">Create</button>
              </div>
            </div>
          </DashboardCard>

          {/* Tournaments Card */}
          <DashboardCard title="Active Tournaments">
        ...
        {/* === CENTRAL COLUMN: WELCOME & COMMUNITY === */}
        <div className="space-y-6">
          ...
          <DashboardCard title="Community Posts">
            <div className="aspect-video bg-[#1a1a1a] rounded-lg mb-4 flex flex-col items-center justify-center border border-[#222] group cursor-pointer overflow-hidden">
                <div className="text-gray-600 group-hover:scale-110 transition-transform">
                  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" viewBox="0 0 256 256"><path d="M208,32H48A16,16,0,0,0,32,48V208a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V48A16,16,0,0,0,208,32ZM48,48H208V157.51l-42.34-42.34a8,8,0,0,0-11.32,0L48,221.51ZM208,208H70.63l114-114L208,117.37V208ZM160,88a16,16,0,1,1-16-16A16,16,0,0,1,160,88Z"></path></svg>
                </div>
            ...
            <div className="flex justify-between items-center text-xs">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-white font-bold">JESSEKID</span>
                </div>
                <div className="flex gap-4 font-bold text-[10px]">
                    <span className="hover:text-white cursor-pointer">0 LIKES</span>
                    <span className="hover:text-white cursor-pointer">COMMENTS</span>
                </div>
            </div>
          </DashboardCard>
        </div>

        {/* === RIGHT COLUMN: POINTS & LEADERBOARDS === */}
        <div className="space-y-6">
          {/* Points Card */}
          <DashboardCard>
            <div className="flex justify-between items-center">
              ...
              <div className="bg-orange-600/10 p-3 rounded-lg">
                 <svg className="text-orange-600" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256"><path d="M244.8,150.4a8,8,0,0,1-11.2-1.6A96,96,0,1,0,128,224a95.3,95.3,0,0,0,44.8-11.1,8,8,0,1,1,7.5,14.1A111.3,111.3,0,0,1,128,240a112,112,0,1,1,112-112A111.1,111.1,0,0,1,232,184a8,8,0,0,1-13.6-8.4,95.2,95.2,0,0,0,11.2-47.2,8,8,0,0,1,15.2-3.6ZM128,80a48,48,0,1,0,48,48A48.1,48.1,0,0,0,128,80Zm0,80a32,32,0,1,1,32-32A32.1,32.1,0,0,1,128,160Z"></path></svg>
              </div>
            </div>
          ...
          {/* Leaderboards Card */}
          <DashboardCard title="Global Ranking">
